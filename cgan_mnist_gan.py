...
if __name__ == '__main__':
    ...
    dataset_dir="/opt/datasets/MNIST"
    model_dir="/home/wangm/MIA/DCGAN-MIA/log/G/mnist_model"
    log_dir = "/home/wangm/MIA/DCGAN-MIA/log/G/mnist_picture"
    workers = 2 
    batch_size = 32
    num_epochs = 50
    h=64
    ...
    trainData = torchvision.datasets.MNIST(dataset_dir,train = True,transform = transform,download=True)
    testData = torchvision.datasets.MNIST(dataset_dir,train = False,transform = transform,download=True)
    
    dataloader = torch.utils.data.DataLoader(dataset = trainData,batch_size = batch_size,shuffle = True,drop_last=False)
